...
public class Store {
	...
	public static void setDefaultProductList() {
        productList.add(new Product("Bread", Type.FOOD, 17, true, "Продукты"));
        productList.add(new Product("Milk", Type.FOOD, 30, true, "Продукты"));
        productList.add(new Product("Сапоги", Type.SHOES, 1700, false, "Одежда"));
        productList.add(new Product("Вино", Type.DRINKS, 230, false, "Напитки"));
    }
	...
	public void avgPriceAllProducts() {
		...
		System.out.println("Средняя стоимость товаров составляет " + sum/productList.size());
	}
